...
TEST_CASES = {
    "HUNTS_POND_ROAD": {"road_name": "Hunts pond road", "post_code": "PO14 4PL"},
    "CHRUCH_ROAD": {"road_name": "Church road", "post_code": "SO31 6LW"},
    "BRIDGE_ROAD": {"road_name": "Bridge road", "post_code": "SO31 7GD"},
}
...
WASTE_TYPE_MAP = {"Refuse": "Green bin", "Recycling": "Blue bin"}


class Source:
    def __init__(self, road_name, post_code):
